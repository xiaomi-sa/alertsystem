...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFFF5801F;
	private int underlineColor = 0x33333333;
	private int dividerColor = 0x33333333;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft, height- indicatorHeight/2, lineRight, height, rectPaint);
